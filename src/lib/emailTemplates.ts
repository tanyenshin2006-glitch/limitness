export function protocolEntryConfirmationEmail(name: string) {
  return `
<!DOCTYPE html>
<html>
<head>
        ...
        <div style="max-width:480px; margin:0 auto; background:#111; border:1px solid #222; border-radius:8px; overflow:hidden;">
            ...
            <div style="padding:32px 28px;">
                ...
                <p style="color:#999; font-size:14px; line-height:1.6; margin:0 0 24px;">
                    Your application for Protocol Entry has been received, ${name}.
                </p>

                <p style="color:#999; font-size:14px; line-height:1.6; margin:0 0 24px;">
                    Applications are reviewed. Not all are accepted. Selected applicants will be contacted before the protocol begins.
                </p>

                <p style="color:#fff; font-size:13px; letter-spacing:0.1em; margin:0;">
                    See yourself.
                </p>
            </div>
    ...
    <div style="background:#0a0a0a; padding:40px 20px; font-family:'League Spartan', Arial, sans-serif;">
        <div style="max-width:480px; margin:0 auto; background:#111; border:1px solid #222; border-radius:8px; overflow:hidden;">
            ...
            <div style="padding:32px 28px;">
                ...
                <p style="color:#999; font-size:14px; line-height:1.6; margin:0 0 24px;">
                    ${name}, you've been added to the field for Controlled Batch 01.
                </p>
